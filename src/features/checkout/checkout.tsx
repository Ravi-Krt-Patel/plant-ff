...
import { addressSchema, type Address, type PaymentStatus } from "@/contracts";
...
export function Checkout() {
  const { lines, orders, setOrders, dispatch } = useStore();
                  ...
                  {(
                    [
                      ...
                      },
                      {
                        key: "locality",
                        label: "Locality",
                        placeholder: "Your demo locality",
                      },
                      {
                        key: "landmark",
                      ...
                      },
                      {
                        key: "pin",
                        label: "PIN code",
                        placeholder: "Try 221001",
                      },
                      {
                        key: "instructions",
                        label: "Delivery instructions (optional)",
                        placeholder: "Anything the demo delivery should know?",
                      },
                    ] as const
                  ).map((f) => (
                    <label
                      className={
                        f.key === "line" || f.key === "instructions"
                          ? "span-2"
                          : ""
                      }
                      key={f.key}
